...
const [eir,setEir]=useState(null);
    ...
    function loaddataU(s="0") {
        ...
        axios.get("/api/course?limit=10&pro=title,intro").then(value => {
            ...
            <div key={index} className="col-md-6 col-lg-4 mb-3">
                ...
                <div className="card-footer bg-transparent border-top-0 ">
                    ...
                    <button className="btn btn-outline-warning btn-sm  mb-2 ms-3 " onClick={d => {
                        ...
                        window.location.href = "/admin/sub?_id=" + course._id+"&title="+encodeURIComponent(course.title)
                    }}>
                        Enter
                    </button>
                    ...
                    <button className="btn me-2 btn-sm float-end mb-2 btn-outline-danger" onClick={o => {
                        ...
                        axios.delete(`/api/course?_id=${course._id}`).then(values => {
                            window.location.reload()
                        })
                    }}>
                        Delete
