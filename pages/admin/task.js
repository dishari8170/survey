...
export default function Sub() {
    ...
    function loaddataU(s="0") {
        ...
        axios.get("/api/atask?limit=10&pro=title,data&skip="+s+"&search="+_id+"&on=category").then(value => {
    ...
    return (<OAdminSidebar>
        ...
        <Modal show={show} onHide={() => {
            ...
            <Modal.Body>
                ...
                <Formik
                    initialValues={eir ? eir : {title: "", intro: "", data: rtp.current,thumb:"dp.jpg",point:0,time:"1h:00m",video:""}}

                    onSubmit={async (values, {resetForm}) => {
                        try {
                            values.data = rtp.current;
                            values.category=_id;
                            await axios.post("/api/atask", values);
                        ...
                        <Form>
                            <div className="">
                                <div className="">
                                    ...
                                    <UploadX df={values.thumb} cb={async t => {
                                        await setFieldValue("thumb", t)
                                    }}/>
                                </div>
  ...
  <div>
                                ...
                                <div>
                                    ...
                                    <Field className="form-control" name="time"/>
                                </div> <div>
                                    <label>Video id :</label>
                                    <Field className="form-control" name="video"/>
                                </div>
                    ...
                    <div key={index} className="col-md-6 col-lg-4">
                        ...
                        <div
                            ...
                            <div className="card-body">
                                <h3 className="card-title h5"><img src={dh.ImUrl + "/" + course.thumb} alt=""  height={100}/> {course.title}
                                </h3>
                            ...
                            <div className="card-footer bg-transparent border-top-0 ">
                                ...
                                <button className="btn btn-outline-warning btn-sm  mb-2 ms-3 " onClick={d => {
                                    ...
                                    window.location.href = "/admin/vt?_id=" + course._id
                                }}>
                                    Enter
                                </button>
                                ...
                                <button className="btn me-2 btn-sm float-end mb-2 btn-outline-danger" onClick={o => {
                                    ...
                                    axios.delete(`/api/atask?_id=${course._id}`).then(values => {
                                        window.location.reload()
                                    })
                                }}>
                                    Delete
